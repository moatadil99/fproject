...
<html lang="en">
  ...
  <div class="navbar navbar-dark bg-dark shadow-sm">
    <div class="container">
      ...
      <div>
      <div class="w-30 btn btn-lg btn-primary align-items-end" > <a style="text-decoration: none; color: white;" href="<?= base_url().'admin/login' ?>">Sign In</a></div>
          ...
          foreach ($result as $key => $value) {
           echo"<div class=\"col\">
            <div class=\"card shadow-sm\">
              <img class=\" card-img-top\" width=\"100%\" height=\"225\"  role=\"img\" src='". base_url().$value['blog_img']."' \"></img>
              <div class=\"card-body\">
